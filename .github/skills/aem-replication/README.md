...
- Five skills: configure, replicate, API, troubleshoot, and an orchestrator.
- Java code examples for the Replication API.
- Common troubleshooting scenarios for queues, connectivity, and cache invalidation.
- Shared foundation references under `references/replication-foundation/`.
- Based on the official Adobe AEM 6.5 LTS documentation linked above.
